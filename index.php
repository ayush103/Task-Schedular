...
<div class="jumbotron" style="height: 180px; width: 100%; margin-top: 10px; padding: 2rem 2rem; opcaity: 0.8;">
  ...
  <div class="dropdown" style="float: right;">
    ...
    <br><button type="submit" class="btn btn-danger" name="addbutton" onclick="location.href = 'add.php';" style="border:0px;margin-left: 25px; margin-top: 0px; background-color: #ffffff;"><img src="data:image/png;base64," ></button>
...
<?php 
 if(isset($_POST["insert"]))
 {
    ...
    $det = $_POST['detail'];
    $l= $_POST['label'];
    $query = "INSERT INTO task (`taskid`, `username`, `tname`, `detail`, `label`, `deadline`) VALUES (NULL, '$tn', 'Task3', '$det', '$l', '$dl')";
